...
$dataCat = mysqli_fetch_all($resultCat, MYSQLI_ASSOC);
...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO products (`name`, `price`, `sale_price`, `desc`, `img`, `status`, `category_id`) VALUES ('$nameProduct', '$price', '$salePrice', '$desc', '$img', '', $category )";
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0 d-flex justify-content-between">
              <h6>Create Product | Thêm sản phẩm</h6>
                ...
                <form class="p-3" action="" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="form-group col-6">
                      ...
                      <input type="text" name="price" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập giá gốc">
                    </div>
                    <div class="form-group col-6">
                      <label for="exampleInputPassword1">Giá bán</label>
                      <input type="text" name="sale_price" class="form-control" id="exampleInputPassword1" placeholder="Nhập giá bán">
                    </div>
                  </div>
                  <div class="row">
                    <div class="form-group col-6">
                      <label for="exampleInputEmail1">Mô tả</label>
                      <textarea class="form-control" name="desc" placeholder="Mô tả sản phẩm"></textarea>
                    </div>
                    <div class="form-group col-6">
                      <label for="exampleInputEmail1">Hình ảnh</label>
                      <input type="file" name="img" class="form-control" accept="image/png, image/gif, image/jpeg" />
                    </div>
                  </div>
