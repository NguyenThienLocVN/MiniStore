<?php 
include('../config/db.php'); //Ket noi CSDL
date_default_timezone_set('Asia/Ho_Chi_Minh'); //Khai bao mui gio
$t = time(); //Thoi gian hien tai
$now = date("Y-m-d H:i:s", $t); //Format nam-thang-ngay gio:phut:giay
...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO users (full_name, email, password, gender, address, created_at) VALUES ('".$name."', '".$email."', '".$pass."', '', '', '".$now."')";

    if(mysqli_query($conn, $sql)){
        echo "<script>alert('Đăng ký thành công')</script>";
        header('Location: http://localhost/MiniStore/app/login.php');
    } else {
            ...
            <div class="card z-index-0">
              ...
              <div class="card-body">
                <form method="POST" action="" role="form text-left">
                  <div class="mb-3">
                    <input type="text" required name="name" class="form-control" placeholder="Name" aria-label="Name" aria-describedby="email-addon">
                  </div>
                  <div class="mb-3">
